...
int main() {
    ...
    json_t* val1 = json_integer(10);
    json_t* val2 = json_integer(20);
    json_t* val3 = json_integer(30);
    ...
    assert(json_integer_value(elem) == 20);
    
    elem = json_array_get(arr, 1);
    assert(json_integer_value(elem) == 30);
    
    elem = json_array_get(arr, 2);
    assert(json_integer_value(elem) == 10);
